        ...
        <div class="container-fluid d-sm-flex flex-column align-items-start block-title">
            <div class="row col-md-12 ml-0">
                <h1 class="col-10 mb-2">
                    Редагування користувача #{{ $cashierUser->id }}
                </h1>
                <div class="col-2">
            ...
            <ol class="breadcrumb row mb-2 ml-3">
                ...
                <li class="breadcrumb-item">Редагування користувача #{{ $cashierUser->id }}</li>
            </ol>
        </div>
    </section>
    <div class="content">
        <div class="container-fluid">
            ...
            <form action="{{route('kaca.cashier-users.update', $cashierUser)}}" method="post">@csrf
                <div class="card card-default color-palette-box">
                    <div class="card-header">
                        <h3 class="card-title">Редагування користувача {{ $cashierUser->{\Kaca\Kaca::$userFieldName} }}</h3>
                    </div>
                    <div class="card-body">
