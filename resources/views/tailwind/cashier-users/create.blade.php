<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Додати нового користувача касою</h2>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-kaca-breadcrumbs>
                ...
                <x-kaca-breadcrumb-item>
                    <a href="{{ route('kaca.cashier-users.index') }}"
                       class="text-grey-700 hover:text-grey-900 ml-1 md:ml-2 text-sm font-medium">Всі користувачі сервісу checkbox.ua</a>
                </x-kaca-breadcrumb-item>
                <x-kaca-breadcrumb-item>
                    <span class="text-grey-200 ml-1 md:ml-2 text-sm font-medium">Додати нового користувача касою</span>
                </x-kaca-breadcrumb-item>
            </x-kaca-breadcrumbs>
            ...
            <div class="flex flex-row gap-4">
                <div class="w-full">
                    <x-kaca-card>
                        <x-slot name="header">Додати нового користувача касою</x-slot>
                        <form action="{{route('kaca.cashier-users.store')}}" method="post">
                            @csrf
                            <div>
                                <x-kaca-label>Користувач</x-kaca-label>
